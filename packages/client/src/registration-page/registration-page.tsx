                    ...
                    <div className="flex bg-white rounded-lg shadow-lg overflow-x-auto mx-auto max-w-sm lg:max-w-4xl">
                        ...
                        <div className="w-full p-8 lg:w-1/2">
                            ...
                            <div className="grid gap-4 mb-2 md:grid-cols-2 mt-4">
                                <input className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="firstName" placeholder='First Name'/>
                                <input className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="lastName" placeholder='Last Name'/>
                            </div>
                            <div className="mt-4">
                            ...
                            <div className="mt-4">
                                <input className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="confirmPassword" placeholder='Confirm Password'/>
                            </div>
                            <div className="mt-8">
                                <button className="bg-midnightblue text-fruityorange font-bold py-2 px-4 w-full rounded hover:bg-fruityorange hover:text-midnightblue">Sign Up</button>
                            </div>
                            ...
                            <p className='flex justify-center mt-4 text-sm'>Already have an account? <a href=''><b className='text-fruityorange'> Log In</b></a></p>
                        </div>
                    </div>
                </div>
            </section>
